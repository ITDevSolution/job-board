...
export const AuthenticationDialog = ({ isOpen, onClose }) => {
  return (
    <>
...
function FacebookColorfulIcon(props) {
...
function LinkedinColorfulIcon(props) {
  const { height, width, ...otherProps } = props
...
function GoogleColorfulIcon(props) {
  const { height, width, ...otherProps } = props
