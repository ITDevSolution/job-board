      ...
      <div className="mx-auto max-w-screen-xl px-6 pt-16 sm:px-8">
        <div className="grid grid-cols-1 gap-y-6 gap-x-6 md:!grid-cols-6 md:gap-8 xs:grid-cols-2">
          ...
          <div className="flex flex-col space-y-2">
            ...
            <a href="#">
              <img
                src="/static/images/app_store_download_button.svg"
                alt="download app"
                className="h-12"
              />
            </a>
            <a href="#">
              <img
                src="/static/images/google_play_download_button.svg"
                alt="download app"
                className="h-12"
              />
            </a>
            <a href="#">
              <img
                src="/static/images/app_gallery_download_button.svg"
                alt="download app"
                className="h-12"
              />
            </a>
...
function LinkedInFullIcon(props) {
